...
import { Contract, ZeroAddress, ZeroHash, parseEther, id, MaxUint256 } from "ethers";
...
describe("Funds", function () {
  ...
  const selfSaleData = ethers.AbiCoder.defaultAbiCoder().encode(["uint256", "uint256"], [minimalPrice, minimalPrice]);
