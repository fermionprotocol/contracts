...
describe("FermionFNFT - fractionalisation tests", function () {
  ...
  context("mintFractions - initial fractionalisation", function () {
    ...
    it("The owner can fractionalise a single NFT", async function () {
      ...
      await expect(tx)
        ...
        .withArgs(ZeroAddress, seller.address, fractionsAmount, 0n);
    ...
    it("The owner can fractionalise multiple NFT", async function () {
      ...
      await expect(tx)
        .to.emit(fermionFNFTProxy, "FractionsTransfer")
        .withArgs(ZeroAddress, seller.address, totalFractions, 0n);
  ...
  context("mintFractions - subsequent fractionalisation", function () {
    ...
    it("The owner, different from initial fractionalizer can fractionalise a NFT", async function () {
      ...
      await expect(tx)
        .to.emit(fermionFNFTProxy, "FractionsTransfer")
        .withArgs(ZeroAddress, buyer.address, fractionsAmount, 0n);
  ...
  context("mintAdditionalFractions", function () {
    ...
    it("The fermion can mint additional fractions", async function () {
      ...
      await expect(tx)
        .to.emit(fermionFNFTProxy, "FractionsTransfer")
        .withArgs(ZeroAddress, await fermionMock.getAddress(), additionalAmount, 0n);
  ...
  context("bid", function () {
    ...
    context("Bid with fractions", function () {
      ...
      it("When outbid, the locked amounts are released to previous bidder", async function () {
        ...
        await expect(tx)
          .to.emit(fermionFNFTProxy, "FractionsTransfer")
          .withArgs(await fermionFNFTProxy.getAddress(), bidders[0].address, fractions, 0n);
        ...
        await expect(tx2)
          .to.emit(fermionFNFTProxy, "FractionsTransfer")
          .withArgs(await fermionFNFTProxy.getAddress(), bidders[1].address, fractions2, 0n);
  ...
  context("redeem", function () {
    ...
    it("Bid with fractions", async function () {
      ...
      await expect(tx2)
        .to.emit(fermionFNFTProxy, "FractionsTransfer")
        .withArgs(await fermionFNFTProxy.getAddress(), ZeroAddress, fractions, 0n); // burn fractions
    ...
    it("Bid with votes", async function () {
      ...
      await expect(tx2)
        .to.emit(fermionFNFTProxy, "FractionsTransfer")
        .withArgs(await fermionFNFTProxy.getAddress(), ZeroAddress, votes, 0n); // burn votes
    ...
    it("Bid with votes and fractions", async function () {
      ...
      await expect(tx2)
        .to.emit(fermionFNFTProxy, "FractionsTransfer")
        .withArgs(await fermionFNFTProxy.getAddress(), ZeroAddress, fractions + votes, 0n); // burn votes and fractions
